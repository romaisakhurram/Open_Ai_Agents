...
async def on_chat_start():
    ...
    agent : Agent = Agent(
        ...
        instructions = "You are a translation agent, Translate the text to user the speak the language. ",
        model = model
    )

    cl.user_session.set("agent" , agent)
    await cl.Message(content = "Welcome to the translator Agent").send()
